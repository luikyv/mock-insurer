...
var (
	Scope = goidc.NewScope("insurance-housing")
)
...
func (Policy) TableName() string {
	return "insurance_housing_policies"
}
...
func (ConsentPolicy) TableName() string {
	return "consent_insurance_housing_policies"
}
...
func (Claim) TableName() string {
	return "insurance_housing_claims"
}
...
const (
	CoverageCodeElectricalDamage                 CoverageCode = "DANOS_ELETRICOS"
	CoverageCodePhysicalDamageToContent          CoverageCode = "DANOS_FISICOS_AO_CONTEUDO"
	CoverageCodePhysicalDamageToProperty         CoverageCode = "DANOS_FISICOS_AO_IMOVEL"
	CoverageCodeDeathAndTotalPermanentDisability CoverageCode = "MORTE_E_INVALIDEZ_TOTAL_E_PERMANENTE"
	CoverageCodeRentPayment                      CoverageCode = "PAGAMENTO_DE_ALUGUEL"
	CoverageCodeBuilderCivilLiability            CoverageCode = "RESPONSABILIDADE_CIVIL_DO_CONSTRUTOR"
	CoverageCodeTheftAndRobberyOfContent         CoverageCode = "ROUBO_E_FURTO_AO_CONTEUDO"
...
type InsuredObjectCoverage struct {
	...
	LMI                       insurer.AmountDetails         `json:"LMI"`
	TermStartDate             timeutil.BrazilDate           `json:"termStartDate"`
	TermEndDate               timeutil.BrazilDate           `json:"termEndDate"`
...
type BranchInfo struct {
	...
	Insureds       []SpecificInsured       `json:"insureds"`
}

type SpecificInsured struct {
	BirthDate                *timeutil.BrazilDate       `json:"birthDate,omitempty"`
	Identification           string                     `json:"identification"`
	IdentificationType       insurer.IdentificationType `json:"identificationType"`
	IdentificationTypeOthers *string                    `json:"identificationTypeOthers,omitempty"`
...
const (
	...
	PropertyTypeCommercial PropertyType = "COMERCIAL"
	PropertyTypeLand       PropertyType = "TERRENO"
	PropertyTypeOthers     PropertyType = "OUTROS"
)
