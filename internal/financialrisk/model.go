...
var (
	Scope = goidc.NewScope("insurance-financial-risk")
)
...
func (Policy) TableName() string {
	return "insurance_financial_risk_policies"
}
...
func (ConsentPolicy) TableName() string {
	return "consent_insurance_financial_risk_policies"
}
...
func (Claim) TableName() string {
	return "insurance_financial_risk_claims"
}
...
const (
	CoverageCodeProtectionOfAssets                                              CoverageCode = "PROTECAO_DE_BENS"
	CoverageCodeProtectionOfOnlineData                                          CoverageCode = "PROTECAO_DE_DADOS_ONLINE"
	CoverageCodeWithdrawalOrPurchaseUnderCoercion                               CoverageCode = "SAQUE_OU_COMPRA_SOB_COACAO"
	CoverageCodeGAPTotal                                                        CoverageCode = "GAP_TOTAL"
...
type PolicyData struct {
	...
	MaxLMG                        *insurer.AmountDetails `json:"maxLMG,omitempty"`
